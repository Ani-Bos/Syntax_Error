...
//  <div class="container my-24 px-6 mx-auto">
  <section class="mb-32 text-gray-900 text-center">
    <h2 class="text-3xl font-bold mb-12">Why is it so<span class="text-green-600"> great?</span></h2>
    <div class="grid md:grid-cols-3 lg:gap-x-12">
      <div class="mb-12 md:mb-0">
        <div class="p-4 bg-green-600 rounded-lg shadow-lg inline-block mb-6">
